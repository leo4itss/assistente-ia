import svgPaths from "./svg-i4ppmtn7vv";
...
export default function CustomizacaoIaPersona() {
  return (
    <div className="content-stretch flex items-center relative size-full" data-name="[Customização IA] Persona">
