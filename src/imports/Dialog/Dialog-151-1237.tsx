import svgPaths from "./svg-qy3hpqah86";
...
function DialogHeader() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-full" data-name="Dialog Header">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#9ca3af] text-[14px] w-full">Esta ação é irreversível. Ao excluir o assistente, todas as conversas serão permanentemente removidas e não poderão ser recuperadas.</p>
    </div>
  );
}
...
export default function Dialog() {
  return (
    <div className="bg-[#111827] content-stretch drop-shadow-[0px_10px_7.5px_rgba(0,0,0,0.1),0px_4px_3px_rgba(0,0,0,0.1)] flex flex-col gap-[32px] items-end p-[24px] relative rounded-[10px] size-full" data-name="Dialog">
        ...
        <div className="h-0 relative shrink-0 w-full" data-name="Separator">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 377 1">
              <line id="Separator" stroke="var(--stroke-0, white)" strokeOpacity="0.1" x2="377" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
      </div>
          ...
          <div className="absolute inset-1/4" data-name="Vector">
            <div className="absolute inset-[-8.31%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33 9.33">
                <path d={svgPaths.p2d1e680} id="Vector" stroke="var(--stroke-0, #F9FAFB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33" />
              </svg>
            </div>
          </div>
        </div>
