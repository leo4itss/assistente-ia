import svgPaths from "./svg-7x1t3yrsvw";
...
function ButtonGroup() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="ButtonGroup">
      <Button />
...
function Tooltip() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[8px] items-center justify-center left-[27px] max-w-[384px] px-[12px] py-[6px] rounded-[8px] top-[537px]" data-name="Tooltip">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#6b7280] text-[12px] whitespace-pre-wrap">Copiar</p>
      <div className="-translate-x-1/2 absolute flex items-center justify-center left-[calc(50%+0.07px)] size-[14.142px] top-[-6.07px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18" } as React.CSSProperties}>
        <div className="-rotate-45 flex-none">
          <div className="relative size-[10px]" data-name="Arrow">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
              <path d={svgPaths.p3a0eac00} fill="var(--fill-0, white)" id="Arrow" />
            </svg>
          </div>
        </div>
      </div>
