import svgPaths from "./svg-k5y0wnyeyw";
...
function Button2() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center justify-center max-h-[36px] max-w-[36px] min-h-[36px] min-w-[36px] opacity-50 px-[16px] py-[8px] relative rounded-[9999px] shrink-0 size-[36px]" data-name="Button">
      <IconSendHorizontal />
    </div>
  );
}
...
export default function InputChatPlaceholder() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative size-full" data-name="InputChat-placeholder">
      <Button />
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic overflow-hidden relative text-[#6b7280] text-[14px] text-ellipsis whitespace-nowrap">Placeholder</p>
      <Button1 />
      <Button2 />
    </div>
  );
