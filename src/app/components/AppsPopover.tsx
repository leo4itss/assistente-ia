import svgPaths from "@/imports/svg-uht81957yr";
...
function Button({ assistantName }: { assistantName?: string }) {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full cursor-pointer" data-name="Button" style={{ backgroundImage: "linear-gradient(90deg, rgba(10, 10, 10, 0.2) 0%, rgba(10, 10, 10, 0.2) 100%), linear-gradient(90deg, rgb(31, 41, 55) 0%, rgb(31, 41, 55) 100%)" }}>
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[8px] relative w-full">
          ...
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#f9fafb] text-[14px] whitespace-nowrap">
            <p className="leading-[20px]">{assistantName || "Leo"} • Assistente IA</p>
          </div>
        </div>
      </div>
    </div>
...
function Button1() {
  return (
    <div className="bg-[rgba(255,255,255,0)] relative rounded-[8px] shrink-0 w-full hover:bg-[rgba(255,255,255,0.05)] transition-colors cursor-pointer" data-name="Button">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[8px] relative w-full">
          <IconSchool />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#f9fafb] text-[14px] whitespace-nowrap">
...
function PopoverContent({ assistantName }: { assistantName?: string }) {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="PopoverContent">
      ...
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="PopoverContent">
        <Button assistantName={assistantName} />
        <Button1 />
        <Button2 />
      </div>
    </div>
...
export default function AppsPopover({ assistantName }: AppsPopoverProps) {
  return (
    <div className="bg-[#1f2937] content-stretch flex flex-col items-start p-[16px] relative rounded-[8px] min-w-[260px]" data-name="Popover">
      ...
      <PopoverContent assistantName={assistantName} />
    </div>
  );
}
