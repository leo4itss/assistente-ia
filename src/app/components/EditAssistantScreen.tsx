  ...
  return (
    ...
    <div className="content-stretch flex items-start relative w-full h-full bg-[#030712]">
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative">
        ...
        {/* Form Content */}
        <div className="bg-[#111827] flex-[1_0_0] min-h-0 overflow-y-auto relative w-full [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-[#374151] [&::-webkit-scrollbar-thumb]:rounded-full">
